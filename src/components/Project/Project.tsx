      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ahmadaliyu" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Kredi - Financial Services Platform</h3>
              <p>
                Developed a comprehensive fintech platform providing digital banking, payments, and lending services. Built scalable mobile and web applications handling thousands of daily transactions with real-time processing.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>White Axis - Ride-Hailing Platform</h3>
              <p>
                Built a Bolt-like transportation platform with real-time GPS tracking, driver-rider matching algorithms, and payment integration. Developed both driver and passenger mobile applications with seamless user experience.
              </p>
            </div>
            <footer> <ul className="tech-list"> <li>React Native</li> <li>Kotlin</li> <li>JavaScript</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>NippyEats - Food Delivery Platform</h3>
              <p>
                Created a food delivery mobile application connecting restaurants with customers. Implemented real-time order tracking, restaurant management dashboard, and delivery driver coordination system.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Loopscribe - Content Management Platform</h3>
              <p>
                Developed a comprehensive content management and collaboration platform with real-time editing capabilities. Built responsive web and mobile applications with seamless synchronization across devices.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Everyfarmer Ecosystem - AgriTech Platform</h3>
              <p>
                Built an agricultural technology platform connecting farmers with markets, suppliers, and agricultural information. Developed mobile and web applications to facilitate farm management, marketplace transactions, and agricultural advisory services.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Active contributor to various open-source projects on GitHub. Contributed to React Native libraries, TypeScript utilities, and mobile app development tools. Check out my GitHub profile for more projects and contributions.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
